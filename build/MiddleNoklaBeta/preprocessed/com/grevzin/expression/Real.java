...
/*
 * Real.java - библиотека для вычислений с плавающей запятой, в NGCalc используемая для
 * хранения и непосредственных действий над числами.
 * Написана Роаром Лауритценом. Распростаряется по GNU GPL или на платной основе.
 */
 ...
 *   Last Place. An error bound of Ѕ ULP means that the result is correctly
...
public final class Real {
    ...
    private static final byte[] clz_tab = {31, 22, 30, 21, 18, 10, 29, 2, 20, 17, 15, 13, 9, 6, 28, 1,
    ...
    public void and(Real a) {
        ...
        if ((this.exponent < 0 && this.mantissa == 0) || (a.exponent < 0 && a.mantissa == 0)) {
            if (!(this.exponent < 0 && this.mantissa == 0) && (this.sign != 0)) {
                ...
                ;
            } else if (!(a.exponent < 0 && a.mantissa == 0) && (a.sign != 0)); // ASSIGN(this,this)
            else if ((this.exponent < 0 && this.mantissa == 0) && (a.exponent < 0 && a.mantissa == 0)
                    && (this.sign != 0) && (a.sign != 0)); // makeInfinity(1)
            else {
                makeZero();
            }
            return;
    ...
    public void or(Real a) {
        ...
        if ((this.exponent < 0 && this.mantissa == 0) || (a.exponent < 0 && a.mantissa == 0)) {
            if (!(this.exponent < 0 && this.mantissa == 0) && (this.sign != 0)); // ASSIGN(this,this);
    ...
    public void gamma() {
        ...
        // x>n: gamma(x) = exp((x-1/2)*ln(x) - x + ln(2*pi)/2 + 1/12x - 1/360xі
     ...
     * overline;">&pi;</span>&nbsp;·<i>e</i><sup>-tІ</sup>&nbsp;dt. It is
